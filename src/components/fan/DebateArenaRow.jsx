      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {debates.map((debate) => {
            ...
            const pctA = total > 0 ? Math.round((debate.optionA.votes / total) * 100) : 50;
            return (
              <article key={debate.id} className="relative rounded-xl overflow-hidden border dark:border-untold-border light:border-gray-200 min-h-[220px]">
                {debate.image && <img src={debate.image} alt="" className="absolute inset-0 w-full h-full object-cover" />}
